...
package STM32_SVD.PWR is
   ...
   --  CSR_EWUP array
   type CSR_EWUP_Field_Array is array (1 .. 8) of Boolean
   ...
   type CSR_Register is record
      ...
      PVDO           : Boolean := False;
      --  Read-only. VREFINT reference voltage ready
   ...
   for CSR_Register use
     record
       ...
       SBF at 0 range 1 .. 1;
       PVDO at 0 range 2 .. 2;
       VREFINTRDY at 0 range 3 .. 3;
       Reserved_4_7 at 0 range 4 .. 7;
       EWUP at 0 range 8 .. 15;

...
package STM32_SVD.CAN is
   ...
   type CAN_TSR_TME_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  TME as a value
            Val : HAL.UInt3;
   ...
   type CAN_TSR_LOW_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  LOW as a value
            Val : HAL.UInt3;
   ...
   type CAN_TDL0R_DATA_Field_Array is array (0 .. 3) of CAN_TDL0R_DATA_Element
   with Component_Size => 8, Size => 32;

   --  CAN_TDL0R
   type CAN_TDL0R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  DATA as a value
            Val : HAL.UInt32;
   ...
   type CAN_TDH0R_DATA_Field_Array is array (4 .. 7) of CAN_TDH0R_DATA_Element
   with Component_Size => 8, Size => 32;

   --  CAN_TDH0R
   type CAN_TDH0R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  DATA as a value
            Val : HAL.UInt32;
   ...
   type CAN_TDL1R_DATA_Field_Array is array (0 .. 3) of CAN_TDL1R_DATA_Element
   with Component_Size => 8, Size => 32;

   --  CAN_TDL1R
   type CAN_TDL1R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  DATA as a value
            Val : HAL.UInt32;
   ...
   type CAN_TDH1R_DATA_Field_Array is array (4 .. 7) of CAN_TDH1R_DATA_Element
   with Component_Size => 8, Size => 32;

   --  CAN_TDH1R
   type CAN_TDH1R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  DATA as a value
            Val : HAL.UInt32;
   ...
   type CAN_TDL2R_DATA_Field_Array is array (0 .. 3) of CAN_TDL2R_DATA_Element
   with Component_Size => 8, Size => 32;

   --  CAN_TDL2R
   type CAN_TDL2R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  DATA as a value
            Val : HAL.UInt32;
   ...
   type CAN_TDH2R_DATA_Field_Array is array (4 .. 7) of CAN_TDH2R_DATA_Element
   with Component_Size => 8, Size => 32;

   --  CAN_TDH2R
   type CAN_TDH2R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  DATA as a value
            Val : HAL.UInt32;
   ...
   type CAN_RDL0R_DATA_Field_Array is array (0 .. 3) of CAN_RDL0R_DATA_Element
   with Component_Size => 8, Size => 32;

   --  CAN_RDL0R
   type CAN_RDL0R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  DATA as a value
            Val : HAL.UInt32;
   ...
   type CAN_RDH0R_DATA_Field_Array is array (4 .. 7) of CAN_RDH0R_DATA_Element
   with Component_Size => 8, Size => 32;

   --  CAN_RDH0R
   type CAN_RDH0R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  DATA as a value
            Val : HAL.UInt32;
   ...
   type CAN_RDL1R_DATA_Field_Array is array (0 .. 3) of CAN_RDL1R_DATA_Element
   with Component_Size => 8, Size => 32;

   --  CAN_RDL1R
   type CAN_RDL1R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  DATA as a value
            Val : HAL.UInt32;
   ...
   type CAN_RDH1R_DATA_Field_Array is array (4 .. 7) of CAN_RDH1R_DATA_Element
   with Component_Size => 8, Size => 32;

   --  CAN_RDH1R
   type CAN_RDH1R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  DATA as a value
            Val : HAL.UInt32;
   ...
   for CAN_RDH1R_Register use
     record
       Val at 0 range 0 .. 31;
       Arr at 0 range 0 .. 31;
     end record;

   subtype CAN_FMR_CAN2SB_Field is HAL.UInt6;
   ...
   --  CAN_FM1R_FBM array
   type CAN_FM1R_FBM_Field_Array is array (0 .. 27) of Boolean
   with Component_Size => 1, Size => 28;

   --  Type definition for CAN_FM1R_FBM
   type CAN_FM1R_FBM_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FBM as a value
            Val : HAL.UInt28;
   ...
   --  CAN_FS1R_FSC array
   type CAN_FS1R_FSC_Field_Array is array (0 .. 27) of Boolean
   with Component_Size => 1, Size => 28;

   --  Type definition for CAN_FS1R_FSC
   type CAN_FS1R_FSC_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FSC as a value
            Val : HAL.UInt28;
   ...
   --  CAN_FFA1R_FFA array
   type CAN_FFA1R_FFA_Field_Array is array (0 .. 27) of Boolean
   with Component_Size => 1, Size => 28;

   --  Type definition for CAN_FFA1R_FFA
   type CAN_FFA1R_FFA_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FFA as a value
            Val : HAL.UInt28;
   ...
   --  CAN_FA1R_FACT array
   type CAN_FA1R_FACT_Field_Array is array (0 .. 27) of Boolean
   with Component_Size => 1, Size => 28;

   --  Type definition for CAN_FA1R_FACT
   type CAN_FA1R_FACT_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FACT as a value
            Val : HAL.UInt28;
   ...
   type F0R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F1R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F2R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F3R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F4R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F5R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F6R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F7R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F8R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F9R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F10R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F11R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   --  Filter bank 4 register 1
   type F12R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F13R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F14R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F15R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F16R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F17R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F18R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F19R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F20R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F21R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F22R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F23R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F24R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F25R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F26R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;
   ...
   type F27R_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  FB as a value
            Val : HAL.UInt32;

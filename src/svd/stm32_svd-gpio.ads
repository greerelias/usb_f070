...
package STM32_SVD.GPIO is
   ...
   type MODER_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  MODER as a value
            Val : HAL.UInt32;
   ...
   type OTYPER_OT_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  OT as a value
            Val : HAL.UInt16;
   ...
   type OSPEEDR_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  OSPEEDR as a value
            Val : HAL.UInt32;
   ...
   type PUPDR_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  PUPDR as a value
            Val : HAL.UInt32;
   ...
   type IDR_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  IDR as a value
            Val : HAL.UInt16;
   ...
   type ODR_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  ODR as a value
            Val : HAL.UInt16;
   ...
   type BSRR_BS_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  BS as a value
            Val : HAL.UInt16;
   ...
   type BSRR_BR_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  BR as a value
            Val : HAL.UInt16;
   ...
   type LCKR_LCK_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  LCK as a value
            Val : HAL.UInt16;
   ...
   type AFRL_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  AFRL as a value
            Val : HAL.UInt32;
   ...
   type AFRH_Register (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  AFRH as a value
            Val : HAL.UInt32;
   ...
   type BRR_BR_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  BR as a value
            Val : HAL.UInt16;

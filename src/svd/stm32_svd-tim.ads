...
package STM32_SVD.TIM is
   ...
   for CCMR1_Input_Register_1 use
     record
       CC1S at 0 range 0 .. 1;
   ...
   for CCR4_Register_1 use
     record
       CCR4_L at 0 range 0 .. 15;
       CCR4_H at 0 range 16 .. 31;
     end record;

   subtype DMAR_DMAR_Field is HAL.UInt16;
   ...
   for CCMR1_Output_Register_1 use
     record
       CC1S at 0 range 0 .. 1;
       OC1FE at 0 range 2 .. 2;
       OC1PE at 0 range 3 .. 3;
   ...
   for CCMR1_Input_Register_2 use
     record
       CC1S at 0 range 0 .. 1;
       IC1PSC at 0 range 2 .. 3;
       IC1F at 0 range 4 .. 7;
   ...
   for CCMR1_Output_Register_2 use
     record
       CC1S at 0 range 0 .. 1;
       OC1FE at 0 range 2 .. 2;
       OC1PE at 0 range 3 .. 3;
   ...
   type TIM1_Disc is (Output, Input);

   --  Advanced-timers
   type TIM1_Peripheral (Discriminent : TIM1_Disc := Output) is record
      --  control register 1
   ...
   type TIM2_Disc is (Output, Input);

   --  General-purpose-timers
   type TIM2_Peripheral (Discriminent : TIM2_Disc := Output) is record
      --  control register 1
      CR1  : aliased CR1_Register;
      --  control register 2
   ...
   type TIM14_Disc is (Output, Input);

   --  General-purpose-timers
   type TIM14_Peripheral (Discriminent : TIM14_Disc := Output) is record
      --  control register 1
   ...
   type TIM15_Disc is (Output, Input);

   --  General-purpose-timers
   type TIM15_Peripheral (Discriminent : TIM15_Disc := Output) is record
      --  control register 1
   ...
   type TIM16_Disc is (Output, Input);

   --  General-purpose-timers
   type TIM16_Peripheral (Discriminent : TIM16_Disc := Output) is record
      --  control register 1
      CR1  : aliased CR1_Register_3;
      --  control register 2
